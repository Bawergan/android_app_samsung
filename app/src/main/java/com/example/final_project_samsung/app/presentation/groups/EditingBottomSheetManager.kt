        ...
        ModalBottomSheet(onDismissRequest = {
            ...
            Column {
                Button(onClick = {
                    ...
                    com.example.final_project_samsung.app.data.listOfGroupData.add(group)
...
//                    groupsUiState.groupList.removeLast()
                ...
                if (groupsUiState.chosenGroup.value != null) {
                    Button(onClick = {
                        ...
                        com.example.final_project_samsung.app.data.listOfGroupData.remove(group)
            ...
            Column {
                Button(onClick = {
                    ...
                    if (groupsUiState.groupList.size == 0) {
                        ...
                        com.example.final_project_samsung.app.data.listOfGroupData.add(newGroup)
                    }
                    ...
                    com.example.final_project_samsung.app.data.listOfEventData.add(event)
                ...
                if (groupsUiState.chosenEvent.value != null) {
                    Button(onClick = {
                        ...
                        com.example.final_project_samsung.app.data.listOfEventData.remove(event)
